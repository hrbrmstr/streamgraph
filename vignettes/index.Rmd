---
title: "Introduction to streamgraph"
output:
  html_document:
    theme: spacelab
    highlight: tango
...
```{r krbabies, message=FALSE, fig.width=10, fig.cap="'Kr-' names (1880-2013)"}
library(dplyr)
library(babynames)
library(streamgraph)
...
```{r ibabies, message=FALSE, fig.width=10, fig.cap="'I-' names (1880-2013)"}
library(dplyr)
library(babynames)
library(streamgraph)
...
```{r movies, message=FALSE, fig.width=10, fig.cap="Count of movie genres over time"}
ggplot2::movies %>%
